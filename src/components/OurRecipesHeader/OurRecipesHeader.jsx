...
const OurRecipesHeader = () => {
    return (
        <div>
            <div className="text-center lg:mx-16 mx-2 px-52 my-6">
                <h2 className="text-3xl font-bold text-[#150B2B]">Our Recipes</h2>
...
export default OurRecipesHeader;